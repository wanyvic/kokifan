<template>
  <div class="login">
    ...
    <input type="text" placeholder="please input your private key..." v-model="PrivKey" />
  ...
  methods: {
    login() {
      ...
      this.$store
        ...
        .then(resolve => {
          const node = this.$store.getters.node;
